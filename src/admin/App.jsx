...
import {
  // Icons
  Calendar, Calendar2, CalendarDays, Clock,
  Users, GraduationCap,
  Settings, Copy, Trash2, Save, X, Plus, Edit, Edit2, Edit3, Download, RefreshCw, Move,
  AlertCircle, AlertTriangle, CheckCircle, Check,
  ChevronLeft, ChevronRight, ChevronDown, ChevronUp,
  Grid, Grid3X3, List, Filter, MoreHorizontal,
  BarChart, FileText, TrendingUp, Activity,
  Play, Pause, Square,
  Eye, EyeOff,
  Wrench, Droplets,
  TennisBall, Court, Trophy, Star,
  Bot, MessageCircle,
  greyFilter,
  // UI Components
  HoverCard,
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        type="number"
                        step="0.01"
                        value={settings.guestFees?.weekday || 15.00}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        type="number"
                        step="0.01"
                        value={settings.guestFees?.weekend || 20.00}
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
          ...
          <div className="mt-6 p-4 bg-gray-100 rounded">
            ...
            <div className="mt-2 text-xs text-blue-600">
              📊 DataStore: {dataStore?.getMetrics?.().cacheHitRate || 0}% cache hit rate | {dataStore?.getMetrics?.().totalOperations || 0} ops
            </div>
          </div>
        </div>
      </div>
