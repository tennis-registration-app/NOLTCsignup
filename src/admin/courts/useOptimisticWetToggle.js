 ...
 */
export function useOptimisticWetToggle({ wetCourts, clearCourt }) {
  const [optimisticWetCourts, setOptimisticWetCourts] = useState(null);
   ...
   */
  const setBulkInFlight = useCallback((inFlight) => {
