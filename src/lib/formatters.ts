 ...
 */
export function formatTimeRemaining(endTimeInput: Date | string | number | null | undefined, currentTime = new Date(), options: { appendLeftSuffix?: boolean; showOvertimeRemainder?: boolean } = {}) {
