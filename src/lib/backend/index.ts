...
import { TennisQueries } from './TennisQueries';
import { TennisCommands } from './TennisCommands';
import { TennisDirectory } from './TennisDirectory';
import { AdminCommands } from './admin/AdminCommands';
export { DenialCodes } from './types';
...
let instance: TennisBackend | null = null;
