 ...
 */
interface Partner { name?: string; memberNumber?: string; id?: string; }
interface FrequentPartnersListProps { partners: Partner[]; loading: boolean; maxPartners?: number; onSelect: (p: Partner) => void; }
